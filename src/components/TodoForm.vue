...
<template>
    <form class="flex items-center gap-5" @submit.prevent="dispatchTodo">
        <input type="text" name="username" id="username"
            ...
            placeholder="What's on your mind?" :value="todoValue" @input="onInput">
        <button type="submit"
            class="rounded-md p-4 text-sm font-semibold text-white shadow-sm hover:bg-[#42B883] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#42B883] bg-[#42B883]">Add</button>
    </form>
</template>